...
const SearchArea = ({
  ...
  return (
    <button
      className="btn btn-primary text-primary-content absolute top-28 left-18 z-[500]"
      onClick={() => {
...
const LandingMap = () => {
  const defaultCenter = useMemo(
    () => [-33.8708, 151.2073] as [number, number],
    []
  );
  ...
  return (
    <div className="h-screen w-screen z-0">
      ...
      >
        ...
        {showToilets && !!bounds && (
          <PublicToilets bbox={bounds} setSelectedToilet={setSelectedToilet} />
        )}
